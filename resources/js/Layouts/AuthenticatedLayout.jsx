        ...
        <div className="min-h-screen bg-gray-100">
            <nav className="bg-white border-b border-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 md:flex">
                                <NavLink href={route('addproduct')} active={route().current('addproduct')}>
                                    Product
                                </NavLink>
                            </div>
                            <div className="hidden  space-x-8 sm:-my-px sm:ml-10 md:flex">
                                <NavLink href={route('admin-transaction')} active={route().current('admin-transaction')}>
                                    Transaction
                                    <div className="badge">{order.length}</div>
                                </NavLink>
                            </div>
                        </div>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' md:hidden'}>
                    ...
                    <div className="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink href={route('addproduct')} active={route().current('addproduct')}>
                            Add Product
                        </ResponsiveNavLink>
                    </div>
                    <div className="pt-2 pb-3 space-y-1">
